...
import 'new_add_burial_location_copy_model.dart';
export 'new_add_burial_location_copy_model.dart';

class NewAddBurialLocationCopyWidget extends StatefulWidget {
  const NewAddBurialLocationCopyWidget({super.key});

  static String routeName = 'newAddBurialLocationCopy';
  static String routePath = '/newAddBurialLocationCopy';

  @override
  State<NewAddBurialLocationCopyWidget> createState() =>
      _NewAddBurialLocationCopyWidgetState();
}

class _NewAddBurialLocationCopyWidgetState
    extends State<NewAddBurialLocationCopyWidget> {
  late NewAddBurialLocationCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewAddBurialLocationCopyModel());
    ...
    _model.amountTextController1 ??=
        TextEditingController(text: FFAppState().lotprice.toString());
                  ...
                  children: [
                    Align(
                      ...
                      child: Row(
                        ...
                        ].addToStart(SizedBox(width: 150.0)),
                      ),
                    ),
                    Align(
                            ...
                            child: Container(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: _model.ownerTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                      ...
                      child: Row(
                        ...
                        children: [
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  validator: _model
                                      .blocklotTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options: ['with nitche', 'with mausoleum'],
                            onChanged: (val) =>
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              safeSetState(() {
                                _model.expirationTextController?.text =
                                    dateTimeFormat("yMd", _model.datePicked);
                              });
                              _model.expiredDATE = await actions.setExpired(
                                _model.datePicked,
                              );
                              ...
                              _model.calculateTotalBalance =
                                  await actions.calculateTotalBalance(
                                _model.amountTextController1.text,
                                int.parse(_model.yearsTextController.text),
                              );
                              safeSetState(() {
                                _model.balanceTextController?.text =
                                    _model.calculateTotalBalance!.toString();
                              });
                          ...
                          Text(
                            ...
                            .divide(SizedBox(width: 385.0))
                            .addToStart(SizedBox(width: 132.0)),
                      ),
                    ),
                    Align(
                          ...
                          Container(
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                focusNode: _model.expirationFocusNode,
                                autofocus: false,
                                obscureText: false,
                                decoration: InputDecoration(
                                  isDense: true,
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .expirationTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (selectedFiles != null) {
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData7dj = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadData7dj =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedFiles.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData7dj =
                    ...
                    Align(
                      alignment: AlignmentDirectional(-0.71, 0.34),
                      child: Text(
                        'Balance  every years in PHP',
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          'Below are the details of  lot that must fill up.',
                          style:
                              ...
                              child: Padding(
                                ...
                                child: StreamBuilder<List<ContractRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<ContractRecord>
                                        buttonContractRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final buttonContractRecord =
                                        buttonContractRecordList.isNotEmpty
                                            ? buttonContractRecordList.first
                                            : null;
                                    ...
                                    return FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if ((_model.ownerTextController.text != null && _model.ownerTextController.text != '') &&
                                            (_model.blocklotTextController.text != null &&
                                                _model.blocklotTextController.text !=
                                                    '') &&
                                            (_model.measurementTextController.text != null &&
                                                _model
                                            ...
                                            (_model.balanceTextController.text !=
                                                ...
                                                _model.balanceTextController
                                                        .text !=
                                                    '')) {
                                          if (buttonContractRecord?.location ==
                                              _model.blocklotTextController
                                                  .text) {
                                            await showDialog(
                                              context: context,
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text(
                                                      'blk-lot is already exist!'),
                                                  content: Text('blk-lot '),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
                                            ...
                                            if (confirmDialogResponse) {
                                              // Sync app state with database max ID
                                              FFAppState().contractid =
                                                  buttonContractRecord!
                                                      .contractID;
                                              safeSetState(() {});
                                              // Use proper method to get next ID from database
                                              await FFAppState()
