...
import 'lott_contract_form_model.dart';
export 'lott_contract_form_model.dart';

class LottContractFormWidget extends StatefulWidget {
  const LottContractFormWidget({
    super.key,
    required this.id,
  ...
  static String routeName = 'LottContractForm';
  static String routePath = '/newContractForm';

  @override
  State<LottContractFormWidget> createState() => _LottContractFormWidgetState();
}

class _LottContractFormWidgetState extends State<LottContractFormWidget> {
  late LottContractFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LottContractFormModel());
    ...
    _model.tomblocationTextController ??=
        TextEditingController(text: widget!.lotlocation);
    ...
    _model.diTextController ??=
        TextEditingController(text: _model.datePicked3?.toString());
    _model.diFocusNode ??= FocusNode();
    ...
    if (_model.datePicked3 != null) {
      ...
      if (duration > 0) {
        ...
        final double initialFee =
            double.tryParse(_model.amountTextController?.text ?? '1500') ??
                1500.0;
                                                    ...
                                                    ...mapToFirestore(
                                                      {
                                                        ...
                                                        'totalcontractvalue':
                                                            double.tryParse(_model
                                                                        .totalcontractvalueTextController
                                                                        ?.text ??
                                                                    '0.0') ??
                                                                0.0,
                                                      },
