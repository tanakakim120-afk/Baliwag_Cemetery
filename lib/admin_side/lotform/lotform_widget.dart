                                ...
                                children: [
                                  ...
                                  _buildFormRow([
                                    ...
                                    _buildDateField(
                                      ...
                                      onDateSelected: (picked) {
                                        // Real-time validation: burial date must be greater than death date
                                          ...
                                          showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                  'Date of Burial must be greater than Date of Death.\n\nDate of Death: ${dateTimeFormat("yMd", deceasedEntry.deathDate!)}\nDate of Burial: ${dateTimeFormat("yMd", picked)}',
                                                  style: GoogleFonts.inter(
                                                    fontSize: 16,
                                                    color: const Color(0xFF6B7280),
                                                  ),
